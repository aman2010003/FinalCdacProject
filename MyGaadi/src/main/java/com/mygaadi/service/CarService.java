...
public interface CarService {
    CarResponseDTO addCar(CarRequestDTO dto, MultipartFile[] files, Long sellerId);
    ...
    // ✅ Updated to include sellerId for ownership validation
    CarResponseDTO updateCar(Long id, CarRequestDTO dto, MultipartFile[] images, Long sellerId);
}
